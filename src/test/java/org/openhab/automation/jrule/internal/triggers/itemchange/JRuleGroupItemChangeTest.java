...
public class JRuleGroupItemChangeTest extends JRuleAbstractTest {
    ...
    public void testItemChangeJustGroups() throws ItemNotFoundException {
        ...
        JRuleGroupItemChangeRules rule = initRule(JRuleGroupItemChangeRules.class);
        fireEvents(false, List.of(itemChangeEvent(JRuleGroupItemChangeRules.SUB_GROUP_ITEM, "2", "1"),
    ...
    public void testItemReceivedUpdateJustGroups() throws ItemNotFoundException {
        ...
        JRuleGroupItemChangeRules rule = initRule(JRuleGroupItemChangeRules.class);
        fireEvents(false, List.of(itemReceivedUpdateEvent(JRuleGroupItemChangeRules.SUB_GROUP_ITEM, "1"),
                itemReceivedUpdateEvent(MEMBER_ITEM, "1")));
    ...
    public void testItemReceivedCommandJustGroups() throws ItemNotFoundException {
        ...
        JRuleGroupItemChangeRules rule = initRule(JRuleGroupItemChangeRules.class);
        fireEvents(false, List.of(itemReceivedCommandEvent(JRuleGroupItemChangeRules.SUB_GROUP_ITEM, "1"),
                itemReceivedCommandEvent(MEMBER_ITEM, "1")));
    ...
    public void testItemChange_from() throws ItemNotFoundException {
        ...
        registerItem(new StringItem(JRuleGroupItemChangeRules.GROUP_ITEM_FROM), UnDefType.UNDEF);
    ...
    public void testItemReceivedUpdate() throws ItemNotFoundException {
        Mockito.when(itemRegistry.getItem(JRuleGroupItemChangeRules.SUB_GROUP_ITEM))
                .then((Answer<Item>) invocationOnMock -> {
                    ...
                    Mockito.when(groupItem.getName()).thenReturn(invocationOnMock.getArgument(0));
                    Mockito.when(groupItem.getGroupNames())
                            .thenReturn(List.of(JRuleGroupItemChangeRules.GROUP_ITEM_FROM));
                    Mockito.when(groupItem.getType()).thenReturn(GroupItem.TYPE);
                    return groupItem;
                });
        ...
        JRuleGroupItemChangeRules rule = initRule(JRuleGroupItemChangeRules.class);
        // Only last event should trigger rule method
        fireEvents(false, List.of(itemReceivedUpdateEvent(MEMBER_ITEM, "1"),
                itemReceivedUpdateEvent(JRuleGroupItemChangeRules.SUB_GROUP_ITEM, "2")));
