...
public class JRuleThingActionClassGeneratorTest {
    ...
    public void testGenerateActionsFile() throws ClassNotFoundException, MalformedURLException, NoSuchFieldException,
        ...
        compiler.compile(List.of(new File(targetFolder, "JRuleThingActions.java")),
                "target/classes" + File.pathSeparator + "target/gen");

        File compiledClass = new File(targetFolder, "JRuleThingActions.class");
        ...
        final String className = "org.openhab.automation.jrule.generated.actions.JRuleThingActions";
